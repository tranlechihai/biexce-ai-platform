...
- Core orchestration đã PASS trên OpenCode 1.18.13. Sau khi phát hiện Slim
  ẩn raw specialist ID và sinh alias Director trùng, registry bridge đã được
  sửa và PASS probe tự động; L4 phải chạy lại trên TUI/OpenChamber sau
  khi sinh config mới. Không tái sử dụng evidence UI cũ cho thay đổi này.
